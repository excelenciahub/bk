-- Generation time: Wed, 15 Aug 2018 21:12:16 +0530
-- Host: localhost
-- DB name: bk
...
DROP TABLE IF EXISTS `bk_admin_master`;
CREATE TABLE `bk_admin_master` (
...
INSERT INTO `bk_admin_master` VALUES ('1','Super','Admin','superadmin@gmail.com',NULL,'superadmin','4297f44b13955235245b2497399d7a93','1','0','2018-03-15 21:36:40','','0','2018-04-10 19:54:14','192.168.30.8','1'); 


DROP TABLE IF EXISTS `bk_category_master`;
CREATE TABLE `bk_category_master` (
...
DROP TABLE IF EXISTS `bk_city_master`;
CREATE TABLE `bk_city_master` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
  `slug` varchar(70) NOT NULL,
...
INSERT INTO `bk_city_master` VALUES ('1','Rajkot','rajkot','1','1','0','2018-05-04 21:34:48','127.0.0.1','1','2018-08-15 17:18:15','192.168.30.8','1'),
('2','Ahmedabad','ahmedabad','1','1','0','2018-08-15 17:18:39','192.168.30.8','1','2018-08-15 17:18:39','','0'); 


DROP TABLE IF EXISTS `bk_db_exports`;
CREATE TABLE `bk_db_exports` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bk_db_exports` VALUES ('1','15082018205430.sql','2018-08-15','2018-08-15 20:54:30','127.0.0.1','1'); 


DROP TABLE IF EXISTS `bk_order_master`;
CREATE TABLE `bk_order_master` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bk_order_products`;
CREATE TABLE `bk_order_products` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bk_product_master`;
CREATE TABLE `bk_product_master` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
...
DROP TABLE IF EXISTS `bk_product_price`;
CREATE TABLE `bk_product_price` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bk_site_config`;
CREATE TABLE `bk_site_config` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bk_site_config` VALUES ('1','SITE_NAME','Balkrushna Proteins','Site name','1'),
...
DROP TABLE IF EXISTS `bk_site_config_log`;
CREATE TABLE `bk_site_config_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `option` varchar(100) DEFAULT NULL,
  `value` text,
  `comment` text,
...
DROP TABLE IF EXISTS `bk_state_master`;
CREATE TABLE `bk_state_master` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
...
INSERT INTO `bk_state_master` VALUES ('1','Gujarat','GJ','gujarat','1','0','2018-08-15 16:35:19','','0','2018-08-15 17:25:17','192.168.30.8','1'); 


DROP TABLE IF EXISTS `bk_stop_words`;
CREATE TABLE `bk_stop_words` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bk_stop_words` VALUES ('1','a','1','0','2018-02-01 15:23:20','192.168.30.8','1','2018-02-01 18:38:35','192.168.30.8','1'),
...
DROP TABLE IF EXISTS `bk_user_master`;
CREATE TABLE `bk_user_master` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `first_name` varchar(50) DEFAULT NULL,
  `last_name` varchar(50) DEFAULT NULL,
