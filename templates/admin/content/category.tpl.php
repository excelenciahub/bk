            ...
            <form action="<?php echo CURRENT_URL; ?>" class="form-validate" method="post" enctype="multipart/form-data">
                ...
                <div class="box box-default box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo ucfirst($action); ?> Category</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            <span class="dropdown">
                            	<button type="button" class="dropdown-toggle btn btn-default" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button>
                            	<ul class="dropdown-menu dropdown-menu-right">
                            		<li><a href="<?php echo CURRENT_URL; ?>" class="text-olive"><i class="fa fa-eye"></i> View Category</a></li>
                            	</ul>
                            </span>
                        </div>
                    </div>
                    <div class="box-body">
                                    ...
                                    <select class="form-control chosen-select" name="parent_id" id="parent_id">
                                        ...
                                        <?php
                                            foreach($categories as $key=>$val){
                                                ?>
                                                <option <?php echo $parent_id==$val->id?'selected="selected"':''; ?> value="<?php echo $val->id; ?>"><?php echo $val->name; ?></option>
                                                <?php
                                            }
                                        ?>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php
                                    if($image!=''&&file_exists(DIR_CATEGORY.get_thumb($image,'360x258'))){
                                        ?>
                                        <a class="fancybox" rel="gallery0" href="<?php echo SITE_CATEGORY.$image; ?>">
                                            <img src="<?php echo SITE_CATEGORY.get_thumb($image,'360x258'); ?>" class="img-thumbnail" />
                                        </a>
                                        <?php
                                    }
                                    else if($slug!=''){
                                        ?>
                                        <a class="fancybox" rel="gallery0" href="<?php echo SITE_CATEGORY.NOIMAGEFOUND; ?>">
                                            <img style="width: 150px; height: 150px;" src="<?php echo SITE_CATEGORY.NOIMAGEFOUND; ?>" class="img-thumbnail" />
                                        </a>
                                        <?php
                                    }
                                ?>
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <span class="dropdown">
                        	<button type="button" class="dropdown-toggle btn btn-default" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button>
                        	<ul class="dropdown-menu dropdown-menu-right">
                        		<li><a href="<?php echo CURRENT_URL; ?>?action=add"><i class="fa fa-plus"></i> Add Category</a></li>
